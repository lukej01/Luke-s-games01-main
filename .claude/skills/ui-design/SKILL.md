...
name: ui-design
description: >
  Premium frontend UI design standard targeting Awwwards-level quality. Use this skill
  for ANY frontend task — building components, pages, dashboards, landing pages, apps,
  or artifacts; styling or redesigning existing UIs; creating HTML/CSS/JS or React
  interfaces. Trigger whenever the user mentions: website, component, page, UI, frontend,
  dashboard, landing page, artifact, layout, design, or asks to "build", "create", "style",
  "make it look better", or "redesign" anything visual. Also trigger for vague requests
  like "build me something" if a visual output is implied. Never skip this skill for
  frontend work — it enforces the design system, tokens, animation standards, and
  quality checks that prevent generic AI-looking output.
---
